...
def _serialize_report(report: MonthlyReport) -> dict:
    return {
        ...
        "ai_referred_conversions": report.ai_referred_conversions,
        "aeo_attributed_calls": report.aeo_attributed_calls,
    ...
    reports = [
        {
            ...
            "ai_referred_conversions": r.ai_referred_conversions,
            "aeo_attributed_calls": r.aeo_attributed_calls,
